...
请先登录百度智能云控制台,创建语音识别应用，当您成功创建应用后，在语音识别产品页签下选择“应用列表”，查看已创建的应用。
...
使用：
点击主按钮开始/结束语音输入，删除按钮清除内容，点击“√“插入到当前标签页
...
该功能不仅可用于SWDChat2.2.0，同时也兼容SWDChat1.X版本，并且支持使用浏览器下载，因此，即使对方电脑上未安装SWDChat，也可以接收文件。
#### 创建及管理文件分享：
